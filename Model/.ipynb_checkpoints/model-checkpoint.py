...
class ESLGradingModelByCandidatesWithAudio(nn.Module):
    ...
    def encode_text(self, input_ids, attention_mask):
        ...
        Returns:
            hidden_states: [B, seq_len, text_hidden_dim]
        """
    ...
    def encode_audio(self, audio):
        ...
        # Reshape based on encoder type
        if self.audio_encoder_type.lower() == 'wav2vec2':
            ...
            # Whisper: [B, num_chunks, 80, time_steps] → [B*num_chunks, 80, time_steps]
        ...
        # FROZEN encoder + TRAINABLE adapter
        with torch.no_grad():
    ...
    def forward(self, input_ids=None, attention_mask=None, audio=None,
        ...
        if self.use_question_encoder and question_input_ids is not None:
            ...
            text_hidden = self.encode_text(input_ids, attention_mask)  # [B, seq_len, text_hidden]
        ...
        if audio_features is not None:
            ...
            # 3. Text-to-Audio Cross-Attention (q=text, kv=audio)
