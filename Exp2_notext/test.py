...
from dataloader import ESLDatasetByCandidatesWithAudio, get_collate_fn_bycandidates_with_audio, get_collate_fn_bycandidates_without_text
...
def build_dataloader(csv_path: str, cfg: Config, tokenizer, audio_processor):
    ...
    collate_fn = get_collate_fn_bycandidates_without_text(
        tokenizer,
